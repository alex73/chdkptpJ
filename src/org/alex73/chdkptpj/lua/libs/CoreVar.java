...
public class CoreVar extends ALuaBaseLib {
    public CoreVar() {
        super("corevar");
    }

    LuaValue verbose = LuaInteger.valueOf(0);

    public OneArgFunction set_verbose = new OneArgFunction() {
    ...
    public ZeroArgFunction get_verbose = new ZeroArgFunction() {
